  ...
  var ACTIONS = [
    ...
    { id: 'if', icon: 'git-branch', cat: 'flow',
      ...
      fields: [
        ...
        { k: 'operator', label: 'p.operator', type: 'options', options: ['exists', 'not_exists', 'visible', 'hidden', 'equals', 'not_equals', 'contains', 'not_contains', 'starts_with', 'ends_with', 'matches_regex', 'greater_than', 'less_than', 'greater_equal', 'less_equal', 'is_empty', 'not_empty', 'is_true', 'is_false', 'in_list', 'not_in_list'] },
