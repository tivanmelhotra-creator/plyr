...
(function () {
  ...
  var DICT = {
    fa: {
      ...
      // ── مدیر فایل‌های Workflow (public/js/workflow-files.js) ─────────────
      'wfm.title': 'فایل‌های Workflow',
      'wfm.close': 'بستن',
      'wfm.root': 'Workflow',
      'wfm.up': 'رفتن به پوشهٔ بالاتر',
    ...
    en: {
      ...
      // ── Workflow File Manager (public/js/workflow-files.js) ──────────
      'wfm.title': 'Workflow Files',
      'wfm.close': 'Close',
      'wfm.root': 'Workflow',
      'wfm.up': 'Go to the parent folder',
