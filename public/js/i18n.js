...
(function () {
  ...
  var DICT = {
    fa: {
      ...
      // دو منبع برای «افزودن فایل»: کامپیوتر خودِ کاربر، یا فایل‌های ماندگارِ همین Workflow روی سرور.
      'rio.choose': 'آپلود از کامپیوتر',
      'rio.fromWorkflow': 'انتخاب از فایل‌های Workflow',
      'rio.filesMenu': 'فایل‌های Workflow',
      'rio.cancel': 'انصراف',
      ...
      // ── کشوی فایل‌های Workflow (public/js/workflow-files.js) ─────────────
      'wfm.title': 'فایل‌های Workflow',
      'wfm.close': 'بستن',
      'wfm.actions': 'کارها',
      'wfm.refresh': 'به‌روزرسانی',
      'wfm.expand': 'باز یا بسته کردن',
      'wfm.open': 'باز کردن',
      'wfm.item': 'مورد',
      'wfm.items': 'مورد',
      'wfm.noItems': 'خالی',
      'wfm.loading': 'در حال خواندن…',
      'wfm.empty': 'این پوشه خالی است. فایلی آپلود کنید یا پوشه‌ای بسازید.',
      'wfm.emptyFolder': 'خالی',
      'wfm.newFolder': 'پوشهٔ جدید',
      'wfm.newFolderPrompt': 'نام پوشهٔ جدید:',
      'wfm.newFile': 'فایل جدید',
      'wfm.newFilePrompt': 'نام فایل جدید:',
      'wfm.upload': 'آپلود فایل',
      'wfm.uploadHere': 'آپلود در این پوشه',
      'wfm.pick': 'انتخاب این فایل',
      'wfm.pickFolder': 'انتخاب این پوشه',
      'wfm.noFolderInInput': 'پوشه‌ها را نمی‌توان به فیلد فایل صفحه داد؛ لطفاً فایل انتخاب کنید.',
      'wfm.select': 'انتخاب',
      'wfm.selectN': 'انتخاب',
      'wfm.selectAll': 'انتخاب همه',
      'wfm.clear': 'پاک کردن انتخاب',
      'wfm.oneSelected': '۱ مورد انتخاب شد',
      'wfm.nSelected': 'مورد انتخاب شد',
      'wfm.oneOnly': 'این صفحه فقط یک فایل می‌پذیرد؛ برای ارسال فقط یکی را انتخاب کنید.',
      'wfm.selectTitle': 'فایل(های) انتخاب‌شده به صفحه داده شود',
      'wfm.download': 'دانلود',
      'wfm.downloadZip': 'دانلود (.zip)',
      'wfm.downloadFolder': 'دانلود این پوشه',
      'wfm.downloadAll': 'دانلود کل فضای کاری (.zip)',
      'wfm.downloadSelTitle': 'دانلود فایل‌های انتخاب‌شده (چند فایل به‌صورت یک .zip)',
      'wfm.downloaded': 'دانلود شد:',
      'wfm.downloadFailed': 'دانلود انجام نشد.',
      'wfm.zipping': 'در حال فشرده‌سازی…',
      'wfm.fetching': 'در حال دریافت…',
      'wfm.rename': 'تغییر نام',
      'wfm.renamePrompt': 'نام جدید:',
      'wfm.delete': 'حذف',
      'wfm.cancel': 'انصراف',
      'wfm.confirmDelete': 'حذف کن',
      'wfm.deleteFileAsk': 'این فایل حذف شود؟',
      'wfm.deleteFolderAsk': 'این پوشه و همهٔ محتویاتش حذف شود؟',
      'wfm.deleteManyAsk': 'فایل‌های انتخاب‌شده حذف شوند؟',
      'wfm.uploading': 'در حال آپلود…',
      'wfm.uploaded': 'آپلود شد.',
      'wfm.sending': 'در حال ارسال…',
      'wfm.notAuthorised': 'دسترسی مجاز نیست.',
      'wfm.refused': 'سرور درخواست را رد کرد',
      'wfm.loadFailed': 'خواندن فایل‌های Workflow ممکن نشد.',
      'wfm.mkdirFailed': 'ساختن پوشه ممکن نشد.',
      'wfm.newFileFailed': 'ساختن فایل ممکن نشد.',
      'wfm.renameFailed': 'تغییر نام ممکن نشد.',
      'wfm.deleteFailed': 'حذف ممکن نشد.',
      'wfm.uploadFailed': 'آپلود ناموفق بود.',
      'wfm.useFailed': 'ارسال فایل به صفحه ممکن نشد.',
      'wfm.noWorkflow': 'این مرورگر از یک Workflow ذخیره‌شده باز نشده، پس فایل‌های Workflow ندارد. اول Workflow را ذخیره کنید.',
      // مسیر (breadcrumb) و پوشه‌های سیستمی uploads/ و downloads/
      'wfm.back': 'بازگشت',
      'wfm.location': 'مسیر',
      'wfm.rootCrumb': 'Workflow',
      'wfm.sysInput': 'ورودی',
      'wfm.sysInputHint': 'فایل‌های اینجا همان چیزی است که به فیلد آپلود صفحه داده می‌شود؛ نسخهٔ «آپلود از کامپیوتر» هم اینجا نگه داشته می‌شود.',
      'wfm.sysOutput': 'خروجی',
      'wfm.sysOutputHint': 'فایل‌هایی که مرورگر هنگام کار برای این Workflow دانلود می‌کند اینجا ذخیره می‌شوند.',
      'wfm.systemLocked': 'این پوشه بخشی از Workflow است و نمی‌توان آن را تغییر نام داد یا حذف کرد.',
      // ── کارهای سازمان‌دهی و آرشیو: جابه‌جایی، کپی، فشرده‌سازی، استخراج ──
      'wfm.move': 'جابه‌جایی',
      'wfm.movePrompt': 'مسیر پوشهٔ مقصد ( نسبت به فضای کاری ):',
      'wfm.moving': 'در حال جابه‌جایی…',
      'wfm.moveDone': 'جابه‌جا شد:',
      'wfm.moveFailed': 'جابه‌جایی ممکن نشد.',
      'wfm.copy': 'کپی',
      'wfm.copyPrompt': 'مسیر پوشهٔ مقصد برای کپی ( نسبت به فضای کاری ):',
      'wfm.copying': 'در حال کپی…',
      'wfm.copyDone': 'کپی شد:',
      'wfm.copyFailed': 'کپی ممکن نشد.',
      'wfm.duplicate': 'تکرار',
      'wfm.duplicated': 'تکرار شد:',
      'wfm.duplicateFailed': 'تکرار ممکن نشد.',
      'wfm.details': 'جزئیات',
      'wfm.folderKind': 'پوشه',
      'wfm.fileKind': 'فایل',
      'wfm.compress': 'فشرده‌سازی (.zip)',
      'wfm.compressSelTitle': 'ساخت یک .zip از موارد انتخاب‌شده',
      'wfm.compressPrompt': 'نام آرشیو:',
      'wfm.compressing': 'در حال ساخت آرشیو…',
      'wfm.compressDone': 'آرشیو ساخته شد:',
      'wfm.compressFailed': 'فشرده‌سازی ممکن نشد.',
      'wfm.extract': 'استخراج',
      'wfm.extractHere': 'استخراج در همین‌جا',
      'wfm.extractFolder': 'استخراج در پوشهٔ جدید',
      ...
      'rc.refreshTabs': 'تازه‌سازی',
      'rc.refreshing': 'در حال تازه‌سازی…',
      'rc.tabsEmpty': 'تب باز نیست (یا کروم اجرا نمی‌شود).',
      'rc.killTab': 'بستن',
      'rc.killTabHint': 'این تب را در کروم واقعی ببند.',
      'rc.killConfirm': 'این تب بسته شود؟',
      'rc.killing': 'در حال بستن…',
      'rc.killed': 'تب بسته شد.',
      // ── Launch options (presets + flag checkboxes + profile provenance) ──
      'rc.launch': 'گزینه‌های اجرا',
      'rc.presetHint': 'یک گزینهٔ استاندارد انتخاب کنید. سوییچ‌های پایین را فقط اگر چیز خاصی لازم دارید باز کنید.',
      'rc.recommended': 'پیشنهادی',
      'rc.advancedFlags': 'سوییچ‌های جداگانه',
      'rc.riskDangerous': 'پرخطر',
      'rc.riskCaution': 'معاوضه‌دار',
      'rc.flagRequired': 'همیشه روشن',
      'rc.flagComputed': 'از تنظیمات',
      'rc.applyFlags': 'اعمال',
      'rc.applying': 'در حال اعمال…',
      'rc.flagsSaved': 'ذخیره شد. اجرای بعدی از این‌ها استفاده می‌کند.',
      'rc.flagsApplied': 'اعمال شد. مرورگر با این سوییچ‌ها دوباره اجرا شد.',
      'rc.flagsNotLive': 'مرورگر در حال اجرا هنوز از این سوییچ‌ها استفاده نمی‌کند. برای اجرای مجدد، «اعمال» را بزنید.',
      'rc.flagsUnknown': 'سوییچ‌های ناشناس نادیده گرفته شدند: ',
      'rc.flagsForced': 'این‌ها را نمی‌توان خاموش کرد: ',
      'rc.profileFrom': 'از ',
      'rc.profileDefault': 'APP_ENV تنظیم نشده — حالت توسعه فرض شد',
      'rc.srcYou': 'شما تنظیم کردید',
      'rc.srcProfile': 'پروفایل انتخاب کرد',
      'rc.srcDefault': 'پیش‌فرض داخلی',
      'rc.overrides': 'به جای ',
      ...
      'fe.workflowGone': 'این workflow دیگر روی سرور وجود ندارد. گراف حفظ شد؛ ذخیرهٔ بعدی یک workflow جدید می‌سازد.',
      ...
      'sb.saving': 'در حال ذخیره…',
      'sb.pending': 'در انتظار همگام‌سازی',
      'sb.saved': 'ذخیره شد',
      'sb.draft': 'پیش‌نویس',
      'sb.on': 'فعال',
      'sb.off': 'خاموش',
      ...
      // -- Element Inspector extension + dual browser mode ---------------
      // The crosshair opens the real browser; these say how to finish the
      // pick there. {node} is substituted via tf(), because the node name
      // does not sit in the same place in fa as in en.
      ...
      'mode.remoteHint': 'مرورگر روی سرور اجرا می‌شود.',
      'mode.localHint': 'کروم خودتان روی همین دستگاه اجرا می‌شود.',
      'mode.switchToRemote': 'تغییر به مرورگر ریموت',
      'mode.switchToLocal': 'تغییر به مرورگر محلی',
      'mode.switched': 'حالت مرورگر تغییر کرد',
      'mode.localDisabled': 'حالت مرورگر محلی روی این سرور خاموش است.',
      'mode.localUnavailable': 'هیچ مرورگر محلی متصل نیست. ابتدا Local Browser Agent را روی دستگاه خود اجرا کنید.',
      'mode.alreadyInMode': 'همین حالا در این حالت هستید.',
      'mode.agentHint': 'برای اتصال مرورگر محلی، این را روی دستگاه خود اجرا کنید: node tools/local-browser-agent.js',
      'mode.connected': 'متصل',
      'mode.notConnected': 'متصل نیست',
      ...
      'cbs.code': 'کد جاوااسکریپت',
      'op.exists': 'وجود دارد',
      'op.not_exists': 'وجود ندارد',
      'op.visible': 'دیده می‌شود',
      'op.hidden': 'پنهان است',
      'op.in_screen': 'در کادر دید صفحه است',
      'op.not_in_screen': 'در کادر دید صفحه نیست',
      ...
      'cbk.code': 'نتیجهٔ یک کد جاوااسکریپت',
      'cbk.codeHint': 'کد را داخل همان صفحه اجرا می‌کند و مقداری که برمی‌گرداند مقدار سمت چپ شرط می‌شود.',
      'cvg.element': 'خواندن از صفحه',
      'cvg.value': 'مقداری که از قبل دارم',
      'cvg.other': 'سایر',
      'cb.codeSnippet': 'کد جاوااسکریپت',
      'cb.codeSnippetHelp': 'داخل صفحه اجرا می‌شود و مقداری که برمی‌گرداند با عملگر پایین مقایسه می‌شود. هم «;return true» و هم یک عبارت تنها مثل «document.title» کار می‌کند. متغیرها با {{نام}} جای‌گذاری می‌شوند. اگر کد خطا بدهد یا طول بکشد، شرط نادرست در نظر گرفته می‌شود.',
      'cb.codeContext': 'بستر اجرای کد (وارد‌شده از Automa)',
    ...
    en: {
      ...
      // Add File, two sources: the operator's own computer, or this workflow's
      // persistent files on the server (public/js/workflow-files.js).
      'rio.choose': 'Upload from Computer',
      'rio.fromWorkflow': 'Choose from Workflow Files',
      'rio.filesMenu': 'Workflow Files',
      'rio.cancel': 'Cancel',
      ...
      // ── the Workflow Files drawer (public/js/workflow-files.js) ───────
      'wfm.title': 'Workflow Files',
      'wfm.close': 'Close',
      'wfm.actions': 'Actions',
      'wfm.refresh': 'Refresh',
      'wfm.expand': 'Expand or collapse',
      'wfm.open': 'Open',
      'wfm.item': 'item',
      'wfm.items': 'items',
      'wfm.noItems': 'empty',
      'wfm.loading': 'Loading\u2026',
      'wfm.empty': 'This folder is empty. Upload a file or create a folder.',
      'wfm.emptyFolder': 'Empty',
      'wfm.newFolder': 'New Folder',
      'wfm.newFolderPrompt': 'New folder name:',
      'wfm.newFile': 'New File',
      'wfm.newFilePrompt': 'New file name:',
      'wfm.upload': 'Upload File',
      'wfm.uploadHere': 'Upload Here',
      'wfm.pick': 'Select',
      'wfm.pickFolder': 'Select this folder',
      'wfm.noFolderInInput': 'Folders cannot be handed to a web page file input; please select files.',
      'wfm.select': 'Select',
      'wfm.selectN': 'Select',
      'wfm.selectAll': 'Select All',
      'wfm.clear': 'Clear',
      'wfm.oneSelected': '1 selected',
      'wfm.nSelected': 'selected',
      'wfm.oneOnly': 'The page takes ONE file; pick just one to send.',
      'wfm.selectTitle': 'Hand the selected file(s) to the page',
      'wfm.download': 'Download',
      'wfm.downloadZip': 'Download (.zip)',
      'wfm.downloadFolder': 'Download this folder',
      'wfm.downloadAll': 'Download workspace (.zip)',
      'wfm.downloadSelTitle': 'Download the selected files (several become one .zip)',
      'wfm.downloaded': 'Downloaded:',
      'wfm.downloadFailed': 'The download failed.',
      'wfm.zipping': 'Zipping\u2026',
      'wfm.fetching': 'Fetching\u2026',
      'wfm.rename': 'Rename',
      'wfm.renamePrompt': 'Rename to:',
      'wfm.delete': 'Delete',
      'wfm.cancel': 'Cancel',
      'wfm.confirmDelete': 'Delete',
      'wfm.deleteFileAsk': 'Delete this file?',
      'wfm.deleteFolderAsk': 'Delete this folder and everything inside it?',
      'wfm.deleteManyAsk': 'Delete the selected files?',
      'wfm.uploading': 'Uploading\u2026',
      'wfm.uploaded': 'Uploaded.',
      'wfm.sending': 'Sending\u2026',
      'wfm.notAuthorised': 'Not authorised.',
      'wfm.refused': 'The server refused',
      'wfm.loadFailed': 'Could not read the workflow files.',
      'wfm.mkdirFailed': 'Could not create the folder.',
      'wfm.newFileFailed': 'Could not create the file.',
      'wfm.renameFailed': 'Could not rename.',
      'wfm.deleteFailed': 'Could not delete.',
      'wfm.uploadFailed': 'The upload failed.',
      'wfm.useFailed': 'The file could not be sent.',
      'wfm.noWorkflow': 'This browser was not opened from a saved workflow, so it has no workflow files. Save the workflow first.',
      // breadcrumb and the system folders uploads/ and downloads/
      'wfm.back': 'Back',
      'wfm.location': 'Location',
      'wfm.rootCrumb': 'Workflow',
      'wfm.sysInput': 'input',
      'wfm.sysInputHint': 'Files here are what a page\u2019s file input is answered with, and where Upload from Computer keeps its copy.',
      'wfm.sysOutput': 'output',
      'wfm.sysOutputHint': 'Files the browser downloads while working for this workflow are filed here.',
      'wfm.systemLocked': 'This folder is part of the workflow and cannot be renamed or deleted.',
      // ── Organise & archive: Move, Copy, Compress, Extract ─────────────
      'wfm.move': 'Move',
      'wfm.movePrompt': 'Destination folder (relative to the workspace):',
      'wfm.moving': 'Moving\u2026',
      'wfm.moveDone': 'Moved:',
      'wfm.moveFailed': 'Could not move.',
      'wfm.copy': 'Copy',
      'wfm.copyPrompt': 'Destination folder to copy into (relative to the workspace):',
      'wfm.copying': 'Copying\u2026',
      'wfm.copyDone': 'Copied:',
      'wfm.copyFailed': 'Could not copy.',
      'wfm.duplicate': 'Duplicate',
      'wfm.duplicated': 'Duplicated:',
      'wfm.duplicateFailed': 'Could not duplicate.',
      'wfm.details': 'Details',
      'wfm.folderKind': 'Folder',
      'wfm.fileKind': 'File',
      'wfm.compress': 'Compress (.zip)',
      'wfm.compressSelTitle': 'Make one .zip from the selected items',
      'wfm.compressPrompt': 'Archive name:',
      'wfm.compressing': 'Building the archive\u2026',
      'wfm.compressDone': 'Archive created:',
      'wfm.compressFailed': 'Could not compress.',
      'wfm.extract': 'Extract',
      'wfm.extractHere': 'Extract here',
      'wfm.extractFolder': 'Extract to new folder',
      ...
      'rc.refreshTabs': 'Refresh',
      'rc.refreshing': 'refreshing…',
      'rc.tabsEmpty': 'No tabs open (or Chrome is not running).',
      'rc.killTab': 'Kill',
      'rc.killTabHint': 'Close this tab in the real Chrome.',
      'rc.killConfirm': 'Close this tab?',
      'rc.killing': 'closing…',
      'rc.killed': 'Tab closed.',
      // ── Launch options (presets + flag checkboxes + profile provenance) ──
      'rc.launch': 'Launch options',
      'rc.presetHint': 'Pick a standard option. Only open the switches below if you need something specific.',
      'rc.recommended': 'recommended',
      'rc.advancedFlags': 'Individual switches',
      'rc.riskDangerous': 'risky',
      'rc.riskCaution': 'trade-off',
      'rc.flagRequired': 'always on',
      'rc.flagComputed': 'from settings',
      'rc.applyFlags': 'Apply',
      'rc.applying': 'applying…',
      'rc.flagsSaved': 'Saved. The next start will use these.',
      'rc.flagsApplied': 'Applied. The browser was relaunched with these switches.',
      'rc.flagsNotLive': 'The running browser is not using these switches yet. Apply to relaunch it.',
      'rc.flagsUnknown': 'Ignored unknown switches: ',
      'rc.flagsForced': 'These cannot be turned off: ',
      'rc.profileFrom': 'from ',
      'rc.profileDefault': 'no APP_ENV set — assuming development',
      'rc.srcYou': 'you set it',
      'rc.srcProfile': 'profile chose it',
      'rc.srcDefault': 'built-in default',
      ...
      'fe.workflowGone': 'This workflow no longer exists on the server. The graph was kept; the next Save creates a new workflow.',
      ...
      'mode.remoteHint': 'The browser runs on the server.',
      'mode.localHint': 'Your own Chrome runs on this machine.',
      'mode.switchToRemote': 'Switch to Remote Browser',
      'mode.switchToLocal': 'Switch to Local Browser',
      'mode.switched': 'Browser mode changed',
      'mode.localDisabled': 'Local Browser mode is turned off on this server.',
      'mode.localUnavailable': 'No local browser is connected. Start the Local Browser Agent on your machine, then try again.',
      'mode.alreadyInMode': 'Already in this mode.',
      'mode.agentHint': 'To connect your local browser, run this on your machine: node tools/local-browser-agent.js',
      'mode.connected': 'Connected',
      'mode.notConnected': 'Not connected',
      ...
      'op.hidden': 'Is hidden',
      'op.in_screen': 'Is visible in screen',
      'op.not_in_screen': 'Is not visible in screen',
      'op.equals': 'Equals',
      ...
      'cbk.code': "A JavaScript snippet's result",
      'cbk.codeHint': 'Runs the code inside the page; whatever it returns becomes the left-hand value.',
      'cvg.element': 'Read from the page',
      'cvg.value': 'A value I already have',
      'cvg.other': 'Other',
      'cb.codeSnippet': 'JavaScript code',
      'cb.codeSnippetHelp': 'Runs inside the page; what it returns is compared with the operator below. Both \"return true;\" and a bare expression such as \"document.title\" work. {{variables}} are substituted first. If the code throws or runs too long, the condition is treated as unmet.',
      'cb.codeContext': 'Code execution context (imported from Automa)',
