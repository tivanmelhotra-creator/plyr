...
- **ادیتور Flow بصری (node-based):** ساخت جریان به‌صورت گراف نودها (الهام از Automa) — هر اکشن یک نود، اتصال بصری نودها، drag-and-drop، pan/zoom و اجرای مستقیم. تبدیل دوطرفه با همان فرمت `steps` بک‌اند. علاوه بر فرم خطی ساده.
